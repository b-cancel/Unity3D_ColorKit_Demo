...
public class colorLerping : MonoBehaviour {
    ...
    void Awake()
    {
        ...
        maxDistanceInRGBColorSpace = gameObject.GetComponent<colorDistances>().distanceBetweenColors(rgb1_255, rgb2_255);
        ...
        maxDistanceInRYBColorSpace = gameObject.GetComponent<colorDistances>().distanceBetweenColors(ryb1_255, ryb2_255);
        ...
        maxDistanceInCMYKColorSpace = gameObject.GetComponent<colorDistances>().distanceBetweenColors(cmyk1_255, cmyk2_255);
    }
        ...
        )
    {
        ...
        switch (LCS)
        {
            case colorSpace.RGB:
                ...
                dist_S_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.RGB, startColor, endColor);
                dist_C_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.RGB, currColor, endColor);
                break;
            case colorSpace.RYB:
                dist_B_2_W = maxDistanceInRYBColorSpace;
                dist_S_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.RYB, startColor, endColor);
                dist_C_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.RYB, currColor, endColor);
                break;
            case colorSpace.CMYK:
                dist_B_2_W = maxDistanceInCMYKColorSpace;
                dist_S_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.CMYK, startColor, endColor);
                dist_C_2_E = gameObject.GetComponent<colorDistances>().distBetweenColors(colorSpace.CMYK, currColor, endColor);
                break;
        }
