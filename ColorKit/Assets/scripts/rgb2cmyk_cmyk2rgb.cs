...
public class rgb2cmyk_cmyk2rgb : MonoBehaviour {
    ...
    public float[] rgb255_to_cmyk255(float[] rgb255)
    {
        ...
        else
        {
            ...
            return gameObject.GetComponent<colorFormatConversion>().colorFloat_to_color255(cmykFloat);
        }
    }

    float[] rgb255_to_cmykFloat(float[] rgb255)
    {
        if (rgb255.Length != 3)
            return new float[] { -1, -1, -1 };
        else
        {
            ...
            else
            {
                ...
                cmykFloat = gameObject.GetComponent<otherColorOps>().clamp(cmykFloat, 0, 1);
    ...
    public float[] cmyk255_to_rgb255(float[] cmyk255)
    {
        ...
        {
            float[] cmykFloat = gameObject.GetComponent<colorFormatConversion>().color255_to_colorFloat(cmyk255);
            return cmykFloat_to_rgb255(cmykFloat);
        }
    }

    float[] cmykFloat_to_rgb255(float[] cmykFloat) //NOTE: all different format conversion types use this function
    {
        ...
        else
        {
            ...
            else
            {
                ...
                rgb255 = gameObject.GetComponent<otherColorOps>().clamp(rgb255, 0, 255);
