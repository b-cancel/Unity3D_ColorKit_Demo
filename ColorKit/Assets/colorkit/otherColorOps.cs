...
public enum mixingMethod { spaceAveraging, colorAveraging, colorComponentAveraging }
...
public class otherColorOps : MonoBehaviour {
    ...
    {
        printArray(begin, gameObject.GetComponent<colorFormatConversions>().color_to_array(col));
    }
    ...
    {
        printArray(begin, gameObject.GetComponent<colorFormatConversions>().vector4_to_array(vect));
    }
    ...
    {
        printArray(begin, gameObject.GetComponent<colorFormatConversions>().vector3_to_array(vect));
    }
    ...
    {
        printArray(begin, gameObject.GetComponent<colorFormatConversions>().vector2_to_array(vect));
    }
    ...
    {
        float[] colorFloat_rGb = gameObject.GetComponent<colorFormatConversions>().color_to_array(origColor);
        float[] color255_rGb = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(colorFloat_rGb);

        float[] result255_rGb = complimentary(color255_rGb, 255);
        float[] resultFloat_rGb = gameObject.GetComponent<colorFormatConversions>().color255_to_colorFloat(result255_rGb);

        return gameObject.GetComponent<colorFormatConversions>().array_to_color(resultFloat_rGb);
    }
    ...
    {
        float[] color1_Float_rGb = gameObject.GetComponent<colorFormatConversions>().color_to_array(color1);
        float[] color1_255_rGb = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(color1_Float_rGb);

        float[] color2_Float_rGb = gameObject.GetComponent<colorFormatConversions>().color_to_array(color2);
        float[] color2_255_rGb = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(color2_Float_rGb);
    ...
    public float distanceBetweenColors(float[] color1, float[] color2)
    {
        if ((color1.Length == color2.Length) && (color1.Length <= 4))
        {
            switch (color1.Length)
            {
                ...
                case 2:
                    Vector2 color1Vect2 = gameObject.GetComponent<colorFormatConversions>().array_to_vector2(color1);
                    Vector2 color2Vect2 = gameObject.GetComponent<colorFormatConversions>().array_to_vector2(color2);

                    return Vector2.Distance(color1Vect2, color2Vect2);
                case 3:
                    Vector3 color1Vect3 = gameObject.GetComponent<colorFormatConversions>().array_to_vector3(color1);
                    Vector3 color2Vect3 = gameObject.GetComponent<colorFormatConversions>().array_to_vector3(color2);

                    return Vector3.Distance(color1Vect3, color2Vect3);
                case 4:
                    Vector4 color1Vect4 = gameObject.GetComponent<colorFormatConversions>().array_to_vector4(color1);
                    Vector4 color2Vect4 = gameObject.GetComponent<colorFormatConversions>().array_to_vector4(color2);
    ...
    Color mixColors_inRGB_colorSpace(mixingMethod mm, Color[] colors, float[] colorQuantities, bool ignoreQuants)
    {
        ...
        {
            float[] colorFloat_RGB = gameObject.GetComponent<colorFormatConversions>().color_to_array(colors[i]);
            float[] color255_RGB = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(colorFloat_RGB);
    ...
    {
        float[] startFloat_rGb = gameObject.GetComponent<colorFormatConversions>().color_to_array(start);
        float[] start255_rGb = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(startFloat_rGb);

        float[] endFloat_rGb = gameObject.GetComponent<colorFormatConversions>().color_to_array(end);
        float[] end255_rGb = gameObject.GetComponent<colorFormatConversions>().colorFloat_to_color255(endFloat_rGb);

        float[] result255_rGb = colorLerp(start255_rGb, end255_rGb, lerpValue);
        float[] resultFloat = gameObject.GetComponent<colorFormatConversions>().color255_to_colorFloat(result255_rGb);

        return gameObject.GetComponent<colorFormatConversions>().array_to_color(resultFloat);
    }
    ...
    public float[] colorLerp(float[] start, float[] end, float lerpValue)
    {
        if (start.Length == start.Length)
        {
            ...
            if (start.Length == 3)
            {
                Vector3 startVect = gameObject.GetComponent<colorFormatConversions>().array_to_vector3(start);
                Vector3 endVect = gameObject.GetComponent<colorFormatConversions>().array_to_vector3(end);

                Vector3 resultVect = Vector3.Lerp(startVect, endVect, lerpValue);

                return gameObject.GetComponent<colorFormatConversions>().vector3_to_array(resultVect);
            }
            else if (start.Length == 4)
            {
                Vector4 startVect = gameObject.GetComponent<colorFormatConversions>().array_to_vector4(start);
                Vector4 endVect = gameObject.GetComponent<colorFormatConversions>().array_to_vector4(end);

                Vector4 resultVect = Vector4.Lerp(startVect, endVect, lerpValue);

                return gameObject.GetComponent<colorFormatConversions>().vector4_to_array(resultVect);
            }
            else
                return start;
        }
